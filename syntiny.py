# A tiny programme for chromosomal syntenies! 
...
def readBED(file, str = 't'):
    ...
    inputs: 
        file:
            BED file
        str:
            file delim - either 's' or 't'
        
    returns:
        BED file formatted as a dataframe
    """
...
def orthologies(genelistA, genelistB, orthologies):
    ...
    outputs: 
        dataframe with all ortholog combinations 
        and their location in species A and B
    """
...
# conducts hypergeometric testing, returns a df with significant chromosome pairs
def sigorthologies(genelistA, genelistB, orthologies):
    ...
    outputs: 
        dataframe with significant ortholog combinations 
...
def rearrangements(data, outfile = 'F'):
    ...
    """
    inputs:
        data: orthology function output
        outfile: not implemented !!
        
    output:
        df with rearrangements, their type, and the chromosomes involved
...
def simulator(Nchr = 20, Ngene = 100, Nevents = 10):
    ...
    outputs:
        ancestor: 
            dummy BED for ancestor
        speciesA: 
            dummy BED for current species
        orthologs: 
            orthologs between ancestor and speciesA
        events: 
            list of events simulates
    """
